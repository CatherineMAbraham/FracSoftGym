...
import numpy as np
import time
from gym_fracture.versions.v0 import utils #calculate_distances, make_scene, getStarts, getGoal, check_done, get_new_pose, unpack_action,fingertip_distance, visualize_contact_forces, world_to_local
from gym_fracture.versions.v0 import env_utils
from scipy.spatial.transform import Rotation as R
import wandb
#from gym_fracture.envs.spring_damper import SpringDamper
from gym_fracture.versions.v0.createligament import make_ligament

class fracturesurgery_env_v0(gym.Env):
    def __init__(
        self,
        render_mode=None,
        reward_type='sparse',
