...
# ,
    ...
    #                     [ 0.        ,  0.        ,  0.        ,  1.        ]]),
    126: np.array([[ 9.49680507e-01, -2.10405678e-01,  2.32026204e-01,
         1.03932922e-03],
       [ 2.04393670e-01,  9.77614045e-01,  4.99374382e-02,
        -8.44684988e-03],
       [-2.37339184e-01, -1.47847459e-08,  9.71426845e-01,
         1.47947948e-02],
       [ 0.00000000e+00,  0.00000000e+00,  0.00000000e+00,
         1.00000000e+00]])
, 
...
def get_patient_goal(env, patient_id):
    ...
    goals = {
        ...
        198: (np.array([0.34174003, -0.08506263,  0.16001045]) - np.array([0.0,-0.02,-0.005]),#np.array([0.34174003, -0.08506263,  0.16001045]) - np.array([0.01,0.01,0.005])#np.array([ 0.32180062,-0.09246775, 0.15800003]) - np.array([0.005,-0.005,0.00])#np.array([ 0.32180062,-0.09246775, 0.15800003]) - np.array([0.005,-0.005,0.00])
              p.getQuaternionFromEuler(p.getEulerFromQuaternion(p.getLinkState(env.pandaUid, 11)[1])-np.array([6.08/180*np.pi,0, 0]))),
        ...
        126: (np.array([ 0.29517541, -0.07789279,  0.13343939])-np.array([-0.010,-0.01,-0.006]),
              p.getQuaternionFromEuler(p.getEulerFromQuaternion(p.getLinkState(env.pandaUid, 11)[1])-np.array([0,10/180*np.pi, 0]))),
    }
