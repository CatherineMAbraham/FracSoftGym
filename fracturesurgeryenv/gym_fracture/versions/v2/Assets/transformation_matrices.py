...
def get_leg_start_working(env):
    p_goals ={252: (0.35180669208315357, -0.030067110398995175, 0.07736699857911723), #252
             ...
             198: (0.3584451445368421, -0.03638827630862719, 0.07212552408980044),
...
def get_patient_goal(env, patient_id):
    ...
    leg = {
        ...
        198: (np.array([0.3470195700516103, -0.13000000000594865, 0.06526955827664446]),
    ...
    goals = {
        ...
        102: (np.array([ 0.30383321, -0.0970693,   0.15603161])-np.array([0.005,-0.0265,0.003]),
              np.array([0.9999999728200057, 0.00023313980271510995, -8.89660707914592e-08, 2.4108688676344187e-06])),
        198: (np.array([0.34174003, -0.08506263,  0.15001045]) - np.array([0.0,-0.02,-0.005]),#np.array([0.34174003, -0.08506263,  0.16001045]) - np.array([0.01,0.01,0.005])#np.array([ 0.32180062,-0.09246775, 0.15800003]) - np.array([0.005,-0.005,0.00])#np.array([ 0.32180062,-0.09246775, 0.15800003]) - np.array([0.005,-0.005,0.00])
        ...
        126: (np.array([ 0.29517541, -0.07789279,  0.13343939])-np.array([-0.010,-0.006,-0.006]),
