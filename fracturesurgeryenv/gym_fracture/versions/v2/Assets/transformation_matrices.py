...
def get_patient_goal(env, patient_id):
    ...
    leg = {
        ...
        198: (np.array([0.3470195700516103, -0.15000000000594865, 0.07526955827664446]),
              np.array([p.getQuaternionFromEuler([90/180*np.pi,0, 0])])),
    ...
    goals = {
        ...
        102: (np.array([ 0.30383321, -0.0970693,   0.15603161])-np.array([0.01,-0.022,0.001]),
              np.array([0.9999999728200057, 0.00023313980271510995, -8.89660707914592e-08, 2.4108688676344187e-06])),
        198: (np.array([0.34174003, -0.08506263,  0.16001045]) - np.array([0.,-0.02,-0.005]),#np.array([0.34174003, -0.08506263,  0.16001045]) - np.array([0.01,0.01,0.005])#np.array([ 0.32180062,-0.09246775, 0.15800003]) - np.array([0.005,-0.005,0.00])#np.array([ 0.32180062,-0.09246775, 0.15800003]) - np.array([0.005,-0.005,0.00])
              p.getEulerFromQuaternion(p.getLinkState(env.pandaUid, 11)[1])-np.array([9.08/180*np.pi,0, 0]))
    }
